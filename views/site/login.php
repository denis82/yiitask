...
<!--            <form class="login-form" action="index.html" method="post">-->
                ...
                <div class="form-group">
                   ...
                   <!-- <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Имя пользователя" name="username" /> </div>-->
                    <?= $form->field($model, 'name')->textInput(["class"=>"form-control form-control-solid placeholder-no-fix", "type"=>"text" ,"autocomplete"=>"off", 'placeholder' =>"Имя пользователя", 'name' => "username"]);  ?>
                <div class="form-group">
                ...
                <div class="create-account">
                    <p>
                        <a href="javascript:;" id="register-btn" class="uppercase">Регистрация</a>
                    </p>
                </div>
<!--</form>-->
            <?php ActiveForm::end(); ?>
            ...
            <form class="forget-form" action="index.html" method="post">
                <h3 class="font-green">Забыл пароль?</h3>
                <p> Введите свой e-mail адрес для изменения пароля. </p>
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="email" /> </div>
                <div class="form-actions">
                    <button type="button" id="back-btn" class="btn green btn-outline">Назад</button>
