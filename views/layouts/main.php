...
<div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
			    ...
			    <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
                            ...
                            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <i class="icon-bell"></i>
                                    <span class="badge badge-default"> 72 </span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="external">
                                        <h3>
				...
				<li class="dropdown dropdown-user">
					<div class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<span class="username username-hide-on-mobile"> Гость </span>
					</div>  
				</li >
                                    <?php else:?>
                            <li class="dropdown dropdown-user">
            ...
            <div class="page-container">
				...
				<li class="heading">
                                <h3 class="uppercase">Основное меню</h3>
                            </li>
                            
                            <?php if (!Yii::$app->user->isGuest):?>
                            <li class="nav-item  ">
                                <a href="<?= Url::to(['site/invite'])?>" class="nav-link nav-toggle">
                                    <i class="icon-diamond"></i>
                                    <span class="title">Пригласить друга</span>
                                </a>
                            ...
                            <li class="nav-item  ">
                                <a href="adminsite" class="nav-link nav-toggle">
